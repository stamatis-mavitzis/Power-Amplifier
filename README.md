...
The repository is organized so that source files, documentation, libraries, and manufacturing outputs remain clearly separated.
...
| Directory | Purpose |
|---|---|
| `Documentation/` | Exported schematics, PDFs, diagrams, and project images |
| `KiCad/` | Editable KiCad design source files |
| `Libraries/` | Project-specific symbols, footprints, and optional 3D models |
| `Manufacturing/Gerber/` | Fabrication layer outputs |
| `Manufacturing/Drill/` | PTH / NPTH drill data |
